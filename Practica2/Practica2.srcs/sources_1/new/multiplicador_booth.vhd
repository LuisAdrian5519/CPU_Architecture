...
entity multiplicador_booth is
    port(
        ...
        A_in              : in  std_logic_vector(3 downto 0);  -- Multiplicador (4 bits)
        B_in              : in  std_logic_vector(3 downto 0);  -- Multiplicando (4 bits)
        ready             : out std_logic;
        resultado         : out std_logic_vector(7 downto 0)   -- Producto (8 bits)
    );
...
process (clk, reset)
    variable tA, tM, tQ : std_logic_vector(3 downto 0) := "0000";  -- 4 bits cada uno
    ...
    if reset = '1' then
        ...
        case contador is
            ...
            when 2|4|6|8 =>
                ...
                tQ := tA(0) & tQ(3 downto 1);          -- Shift Q, MSB viene de A(0)
                tA := tA(3) & tA(3 downto 1);          -- Shift aritmético A (preserva signo)
        ...
        if contador = 0 and working = '0' then
            resultado <= tA & tQ;  -- Concatenar A(4) y Q(4) = 8 bits
        end if;
    end if;
end process;
